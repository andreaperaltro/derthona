...
const logoStates = [
  ...
  { max: 39, lightSrc: 'assets/official/lockup.svg', darkSrc: 'assets/official/lockup-white.svg', name: 'Lockup', use: 'Medium formats', width: '62%', height: '190px' },
  { max: 60, lightSrc: 'assets/official/stacked-primary.svg', darkSrc: 'assets/official/stacked-primary-white.svg', name: 'Stacked Primary', use: 'Compact formats', width: '48%', height: '220px' },
  { max: 80, lightSrc: 'assets/official/stacked-compact.svg', darkSrc: 'assets/official/stacked-compact-white.svg', name: 'Stacked Compact', use: 'Small formats', width: '30%', height: '165px' },
  { max: 100, lightSrc: 'assets/official/lion-symbol.svg', darkSrc: 'assets/official/lion-symbol-white.svg', name: 'Lion symbol', use: 'Very small formats', width: '15%', height: '170px' }
];
...
const glyphGroups = [
  { name: 'Uppercase · Alternate forms', codePoints: [
  ...
  { name: 'Lowercase · Standard forms', codePoints: [
    ...Array.from({ length: 26 }, (_, index) => 0x0061 + index),
    0x00E0, 0x00E1, 0x00E2, 0x00E3, 0x00E4, 0x00E5, 0x00E6, 0x00E7, 0x00E8, 0x00E9, 0x00EA, 0x00EB, 0x00EC, 0x00ED, 0x00EE, 0x00EF, 0x00F0, 0x00F1, 0x00F2, 0x00F3, 0x00F4, 0x00F5, 0x00F6, 0x00F8, 0x00F9, 0x00FA, 0x00FB, 0x00FC, 0x00FD, 0x00FE, 0x00FF
  ] },
  ...
  { name: 'Symbols', codePoints: [0x00A3, 0x00A5, 0x00A6, 0x00A9, 0x00B0, 0x00D7, 0x00F7, 0x0E3F, 0x20AC, 0x20B9, 0x20BD, 0x2190, 0x2191, 0x2192, 0x2193, 0x2196, 0x2197, 0x2198, 0x2199, 0x2260] },
...
if (glyphRoot) {
  glyphGroups.forEach(({ name, codePoints }) => {
    ...
    codePoints.forEach((codePoint) => {
      ...
      code.textContent = formatCodePoint(codePoint);
      card.title = `${formatCodePoint(codePoint)} · ${codePoint === 0x0020 ? 'Space' : codePoint === 0x00A0 ? 'No-break space' : glyph}`;
